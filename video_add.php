        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="actor[]" multiple="multiple" id="actor">
                        ...
                        <?php
                            ...
                            $asstdirectors = $this->db->get_where('star', array('star_type'=>'asst-director'))->result_array();
                        ...
                        <?php endforeach; ?>
                        <option value="" disabled>--Asst. Director--</option>
                        <?php foreach ($asstdirectors as $asstdirector):?>
                            <option value="<?php echo $asstdirector['star_id']; ?>"><?php echo $actor['star_name']; ?></option>
                        <?php endforeach; ?>
                    ...
                    <!-- asst director -->
                    <div class="form-group">
                      <label class="control-label"><?php echo tr_wd('asstdirector'); ?></label>
                      <select class="form-control select2" name="asstdirector[]" multiple="multiple" id="asstdirector">
                        <option value="" disabled>--Asst. Directors--</option>
                        <?php
                            $actors = $this->db->get_where('star', array('star_type'=>'actor'))->result_array();
                            $directors = $this->db->get_where('star', array('star_type'=>'director'))->result_array();
                            $asstdirectors = $this->db->get_where('star', array('star_type'=>'asst-director'))->result_array();
                            $writers = $this->db->get_where('star', array('star_type'=>'writer'))->result_array();
                            foreach ($asstdirectors as $assdirector):?>
                        <option value="<?php echo $asstdirector['star_id']; ?>"><?php echo $asstdirector['star_name']; ?></option>
                        <?php endforeach; ?>
                        <option value="" disabled>--Actors--</option>
                        <?php foreach ($actors as $actor):?>
                            <option value="<?php echo $actor['star_id']; ?>"><?php echo $actor['star_name']; ?></option>
